...
Gaussian spots), the target class the classical kinoform was designed
for \cite{Prongue1992,Bengtsson1998}. Salient unscaled-PSNR means: GS
$44.55$, Bengtsson $45.59$, Fienup $44.99$, NWF $\mathbf{47.22}$,
Overdrive($\beta=0.7$) $45.47$, RAAR $43.28$ (scaled $52.83$, i.e.\
$9.5$~dB of power drift). The Overdrive advantage compresses to
$\approx 1$~dB and the optimum in $\beta$ flattens: on sparse targets
the dimensional-balance bookkeeping buys little over the
$\beta\to 1$ Prongu\'e/Bengtsson limit. NWF's advantage flips here as
the gradient $(|U|^2-y)U$ has structure on sparse $y$ that
log-multiplicative updates do not exploit. Multiplicative-momentum's
home territory is dense grayscale, not sparse points.
